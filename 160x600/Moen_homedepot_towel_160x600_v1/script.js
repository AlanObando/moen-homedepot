...
var towel_container = document.getElementById("towel_container");
...
function frame1ani()
{
  tl.to(towel_container, 0.3,{ease: Back.easingIn, rotation: '-15deg'}, '+=0.5')
    .to(towel, 0.8,{ease: Back.easingOut, skewX: '-10', x: '-=54', y: '-=1'}, '-=0.3')
    .to(text1, 0.5,{ease: Power2.easingOut, alpha: '1'}, '-=1.6')

    .to(frame2, 0.5,{ease: Power2.easingIn, clip: 'rect(0,160px,600px,0)'}, '+=1.3')
    ...
    .to(img2, 1,{ease: Power4.easingOut, scale: '0.85', y: '-=44'}, '-=0.2')
    .call(logoPosition)
