...
function frame1ani()
{
  tl.to(drop1, 0.7,{ease: Power4.easingOut, top: '600px'})
    .to(drop2, 0.3,{ease: Power2.easingOut, top: '28px'}, '-=0.3')
    .to(drop2, 0.2,{ease: Power2.easingOut, top: '-=3'})
    .to(drop2, 0.2,{ease: Power2.easingOut, top: '+=3'})
    .to(drop2, 0.2,{ease: Power2.easingOut, top: '-=3'})
    .to(drop2, 1,{ease: Power4.easingOut, top: '+=600'}, '+=0.8')

    .to(text1, 0.5,{ease: Power2.easingOut, alpha: '1'}, '-=2')
